...
title: Offline-first cryptographic Proof of Delivery (PoD) with photo and signature
  on route-optimization under Network Partitions & Distributed Timeout Failures
...
story:
  ...
  i_want: tamper-proof offline package signature capture and geolocation stamping
    for route-optimization with resilience to Network Partitions & Distributed Timeout
    Failures
