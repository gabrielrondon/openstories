...
title: Offline-first cryptographic Proof of Delivery (PoD) with photo and signature
  on proof-of-delivery under Network Partitions & Distributed Timeout Failures
...
story:
  ...
  i_want: tamper-proof offline package signature capture and geolocation stamping
    for proof-of-delivery with resilience to Network Partitions & Distributed Timeout
    Failures
