...
domain: digital-lease-signing
title: RESO Web API pagination with differential delta synchronization for digital-lease-signing
...
story:
  ...
  i_want: replication-state tracking and delta synchronization for digital-lease-signing
...
- source: https://github.com/reso-standards/reso-web-api/issues/102
  ...
  quote: Our digital-lease-signing sync dropped pending status updates, showing houses
