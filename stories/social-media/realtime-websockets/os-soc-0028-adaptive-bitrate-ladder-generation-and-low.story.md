...
story:
  ...
  i_want: hardware-accelerated multi-rendition HLS transcoding for realtime-websockets
    video uploads with resilience to Asynchronous Race Conditions & Deadlocks
...
- High resolution 4K 60fps uploads overwhelming transcoder worker memory during viral
  events%!(EXTRA string=realtime-websockets) exacerbated by Asynchronous Race Conditions
  & Deadlocks
