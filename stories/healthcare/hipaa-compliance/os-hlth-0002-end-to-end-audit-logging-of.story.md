...
- scenario: Staff member querying patient records without assigned care relationship
    on hipaa-compliance combined with Network Partitions & Distributed Timeout Failures
...
- Emergency department 'break-the-glass' protocols requiring immediate chart override
  during life-threatening triage%!(EXTRA string=hipaa-compliance) exacerbated by Network
