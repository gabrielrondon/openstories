...
title: Two-phase commit inventory locking across external OTA channel managers for
  cancellation-refunds under Asynchronous Race Conditions & Deadlocks
demand_score: 9.09
status: verified
persona:
...
story:
  ...
  i_want: distributed inventory synchronization across Booking.com, Expedia, and direct
    channels for cancellation-refunds with resilience to Asynchronous Race Conditions
    & Deadlocks
...
- Channel API latency delays of several minutes during peak holiday booking events%!(EXTRA
  string=cancellation-refunds) exacerbated by Asynchronous Race Conditions & Deadlocks
