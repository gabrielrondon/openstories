...
title: Two-phase commit inventory locking across external OTA channel managers for
  gds-flight-inventory under Network Partitions & Distributed Timeout Failures
...
story:
  ...
  i_want: distributed inventory synchronization across Booking.com, Expedia, and direct
    channels for gds-flight-inventory with resilience to Network Partitions & Distributed
    Timeout Failures
...
- Channel API latency delays of several minutes during peak holiday booking events%!(EXTRA
  string=gds-flight-inventory) exacerbated by Network Partitions & Distributed Timeout
  Failures
