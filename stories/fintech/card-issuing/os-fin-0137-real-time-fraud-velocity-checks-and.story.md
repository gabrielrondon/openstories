...
industry: fintech
domain: card-issuing
title: Real-time fraud velocity checks and 3DS challenge step-up for card-issuing
...
story:
  ...
  i_want: sliding window card velocity heuristics and adaptive 3D Secure step-up for
    card-issuing with resilience to Idempotency & Replay Attack Vulnerabilities
...
- Distributed botnet cycling residential proxies to evade naive single-IP velocity
  limits exacerbated by Idempotency & Replay Attack Vulnerabilities
...
- source: https://reddit.com/r/stripe/comments/16k29a1
  ...
  quote: Our merchant account was suspended by Visa after a card testing bot hit card-issuing
    with 12,000 stolen cards overnight.
  date: 2024-2025
  platform: ""
evaluation_rubric:
- Does the implementation mitigate distributed botnet cycling residential proxies
  to evade naive single-ip velocity limits exacerbated by idempotency & replay attack
