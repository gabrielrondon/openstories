...
title: FDA 21 CFR Part 11 compliant electronic signature and chain-of-custody for
  electronic-lab-notebooks under Disaster Recovery & Cascading Failover
demand_score: 9.13
status: verified
persona:
...
story:
  ...
  i_want: non-repudiable dual-factor digital signatures and immutable audit trails
    for electronic-lab-notebooks sample approval with resilience to Disaster Recovery
    & Cascading Failover
...
- Sample re-testing producing discordant results requiring formal discrepancy deviation
  investigations%!(EXTRA string=electronic-lab-notebooks) exacerbated by Disaster
