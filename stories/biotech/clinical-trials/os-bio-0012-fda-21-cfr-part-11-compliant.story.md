...
title: FDA 21 CFR Part 11 compliant electronic signature and chain-of-custody for
  clinical-trials under Network Partitions & Distributed Timeout Failures
...
story:
  ...
  i_want: non-repudiable dual-factor digital signatures and immutable audit trails
    for clinical-trials sample approval with resilience to Network Partitions & Distributed
    Timeout Failures
...
- Sample re-testing producing discordant results requiring formal discrepancy deviation
  investigations%!(EXTRA string=clinical-trials) exacerbated by Network Partitions
