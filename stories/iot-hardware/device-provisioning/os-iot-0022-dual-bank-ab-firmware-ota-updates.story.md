...
story:
  ...
  i_want: fail-safe A/B partition OTA updates with hardware watchdog validation for
    device-provisioning with resilience to Network Partitions & Distributed Timeout
    Failures
...
- Firmware that boots successfully but crashes after 5 minutes when connecting to
  WiFi, evading simple boot watchdogs exacerbated by Network Partitions & Distributed
  Timeout Failures
