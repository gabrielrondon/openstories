...
domain: device-provisioning
title: Dual-bank A/B firmware OTA updates with automatic watchdog rollback on device-provisioning
...
story:
  ...
  i_want: fail-safe A/B partition OTA updates with hardware watchdog validation for
    device-provisioning with resilience to Zero-Trust Authentication & Token Invalidation
...
- Firmware that boots successfully but crashes after 5 minutes when connecting to
  WiFi, evading simple boot watchdogs exacerbated by Zero-Trust Authentication & Token
  Invalidation
...
- source: https://github.com/espressif/esp-idf/issues/5291
  ...
  quote: We bricked 3,000 smart irrigation sensors on device-provisioning because
