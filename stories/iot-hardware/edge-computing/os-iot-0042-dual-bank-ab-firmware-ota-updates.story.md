...
title: Dual-bank A/B firmware OTA updates with automatic watchdog rollback on edge-computing
...
story:
  ...
  i_want: fail-safe A/B partition OTA updates with hardware watchdog validation for
    edge-computing with resilience to Network Partitions & Distributed Timeout Failures
...
- source: https://github.com/espressif/esp-idf/issues/5291
  ...
  quote: We bricked 3,000 smart irrigation sensors on edge-computing because the OTA
