...
story:
  ...
  i_want: dynamic nexus and reciprocal agreement calculation for benefits-enrollment
    employee payrolls with resilience to Network Partitions & Distributed Timeout
    Failures
...
- Local city income taxes (e.g. NYC, Philadelphia, Columbus) missed when using state-level
  lookup tables%!(EXTRA string=benefits-enrollment) exacerbated by Network Partitions
