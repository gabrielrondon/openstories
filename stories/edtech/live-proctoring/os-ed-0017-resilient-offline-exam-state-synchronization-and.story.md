...
- System clock tampering on student laptops to artificially extend examination time
  limits%!(EXTRA string=live-proctoring) exacerbated by Idempotency & Replay Attack
  Vulnerabilities
...
- Does the implementation mitigate system clock tampering on student laptops to artificially
  extend examination time limits%!(extra string=live-proctoring) exacerbated by idempotency
